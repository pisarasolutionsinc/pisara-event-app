...
ProjectCard.Image = function CardImage({
  className,
  src,
}: {
  className?: string;
...
ProjectCard.Title = function CardTitle({
  className,
  title,
}: {
  className?: string;
  ...
  return (
    ...
    >
      {title ? title : card?.title ? card?.title : "Default Title"}
    </h1>
  );
};

ProjectCard.Text = function CardText({
  className,
  text,
}: {
  className?: string;
...
ProjectCard.Comments = function CardComments({
  className,
}: {
  className?: string;
}) {
...
ProjectCard.Content = function CardContent({
  className,
  content,
}: {
  className?: string;
...
ProjectCard.Time = function CardTime({
  className,
  time,
  icon,
}: {
...
ProjectCard.Date = function CardDate({
  className,
  date,
  icon,
  label,
...
ProjectCard.KebabMenu = Object.assign(
