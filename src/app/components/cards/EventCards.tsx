...
EventCard.Image = function CardImage({
  className,
  src,
}: {
  className?: string;
...
EventCard.Title = function CardTitle({
  className,
  title,
}: {
  className?: string;
...
EventCard.Text = function CardText({
  className,
  text,
}: {
  className?: string;
...
EventCard.Comments = function CardComments({
  className,
}: {
  className?: string;
}) {
...
EventCard.Content = function CardContent({
  className,
  content,
}: {
  className?: string;
...
EventCard.Time = function CardTime({
  className,
  time,
  icon,
}: {
...
EventCard.Date = function CardDate({
  className,
  date,
  icon,
}: {
...
EventCard.KebabMenu = Object.assign(
