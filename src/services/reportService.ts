...
import { Report as Model } from "../model/reportModel";
...
export class ReportService extends APIService {
  ...
  public async execute(): Promise<Model | undefined> {
    return this.fetchData();
  }

  private async fetchData(): Promise<Model | undefined> {
    ...
    try {
      ...
      // Adjust the return type based on whether the response is an object or an array
