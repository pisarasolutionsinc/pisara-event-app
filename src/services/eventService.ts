...
import { Event as Model } from "../model/eventsModel";
...
export class EventService extends APIService {
  ...
  page(page: number): this {
    this.pageValue = page; // Store page value separately
  ...
  public getBody(): Record<string, any> {
    ...
    // Add page and limit directly to the body, not nested
    if (this.pageValue !== undefined) {
    ...
    return body; // Return the constructed body
  }
