...
export const renderEditableQuestion = (question: Question) => {
      ...
      return (
        ...
        >
          ...
          <input
            ...
            className="block text-sm font-medium text-gray-700 border border-gray-300 rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm mb-2"
          />
          <textarea
            placeholder={question.placeholder || ""}
            required={question.required}
